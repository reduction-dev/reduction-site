...
Create a new project and add the Reduction Go SDK as a dependency. For example:
...
<Tabs>
   ...
   <TabItem value="typescript" label="TypeScript">
      <CodeBlock language="go" title="myjob/index.ts">{quickStartTypeScript}</CodeBlock>
   </TabItem>
</Tabs>
...
1. Build your job as an executable:
