...
import sessionWindowHandlerTypeScript from "!!raw-loader!@site/examples/ts/session-window/index.ts";
import sessionWindowTestTypeScript from "!!raw-loader!@site/examples/ts/session-window/index.test.ts";
...
<Tabs groupId="language">
  ...
  <TabItem value="typescript" label="TypeScript">
    <CodeSnippet
      language="typescript"
      code={sessionWindowHandlerTypeScript}
      marker="json-structs"
    />
  </TabItem>
</Tabs>
...
<Tabs groupId="language">
  ...
  <TabItem value="typescript" label="TypeScript">
    <CodeSnippet
      language="typescript"
      code={sessionWindowTestTypeScript}
      marker="job-setup"
    />
  </TabItem>
</Tabs>
